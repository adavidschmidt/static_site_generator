...
class TestTextNode(unittest.TestCase):
	...
	def test_split_node(self):
		...
		self.assertEqual(new_nodes, [
                ...
                TextType.TEXT), TextNode("code block", TextType.CODE),
       			TextNode(" word", TextType.TEXT),
          		])
  
	def test_split_node_starting_block(self):
		node = TextNode("**Bold this** This is text with a word", TextType.TEXT)
	...
	def test_split_image_only_images(self):
		node = TextNode("![image](https://i.imgur.com/zjjcJKZ.png)![second image](https://i.imgur.com/3elNhQu.png)",
                  TextType.TEXT,
                  )
		new_nodes = split_nodes_image([node])
		self.assertListEqual(
	...
	def test_split_image_only_one_images(self):
		node = TextNode("![image](https://i.imgur.com/zjjcJKZ.png)",
                  TextType.TEXT,
                  )
		new_nodes = split_nodes_image([node])
		self.assertListEqual(
	...
	def test_split_link_only_one_link(self):
